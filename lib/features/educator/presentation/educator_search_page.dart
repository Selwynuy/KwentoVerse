...
class EducatorSearchPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EducatorSearchPage> createState() =>
      _EducatorSearchPageState();
}

class _EducatorSearchPageState extends ConsumerState<EducatorSearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const tileHeight =
        (tilePadding * 2) + coverHeight + titleGap + titleHeight;
