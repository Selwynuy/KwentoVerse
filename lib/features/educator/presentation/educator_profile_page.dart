...
class EducatorProfilePage extends ConsumerStatefulWidget {
  const EducatorProfilePage({super.key});

  @override
  ConsumerState<EducatorProfilePage> createState() =>
      _EducatorProfilePageState();
}

class _EducatorProfilePageState extends ConsumerState<EducatorProfilePage> {
          ...
          child: ConstrainedBox(
            ...
            child: profileAsync.when(
              ...
              error: (e, _) => _ErrorState(
                message: e.toString(),
                onRetry: () => ref.invalidate(myEducatorProfileProvider),
              ),
              data: (profile) {
                final effectiveUserId = userId ?? profile.id;
                final selectedAvatarIndex =
                    _pendingAvatarIndex ?? profile.avatarIndex;
                ...
                return ListView(
                  ...
                  children: [
                      ...
                      child: _UserIdRow(
                        ...
                        onCopy: () async {
                          await Clipboard.setData(
                            ClipboardData(text: effectiveUserId),
                          );
                    ...
                    if (profile.schoolName != null &&
                        profile.schoolName!.trim().isNotEmpty)
                      Center(
                        child: Text(
                          profile.schoolName!,
                          style: TextStyle(
                    ...
                    _QuickAvatarRow(
                      ...
                      onTap: (idx) =>
                          setState(() => _pendingAvatarIndex = idx),
                    ),
                        ...
                        onPressed: !hasChange || _savingAvatar
                            ...
                            : () async {
                                ...
                                try {
                                  ...
                                  ref.invalidate(myEducatorProfileProvider);
                                  if (!context.mounted) return;
